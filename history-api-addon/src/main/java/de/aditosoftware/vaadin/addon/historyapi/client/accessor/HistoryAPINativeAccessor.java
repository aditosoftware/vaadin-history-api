...
public class HistoryAPINativeAccessor {
   ...
   */
  public static native void registerPopStateListener(
      Consumer<ClientHistoryChangeEvent> listenerCallback) /*-{
  ...
  private static void processEvent(
      Consumer<ClientHistoryChangeEvent> callback, String uri, String state) {
