...
/**
 * Describes a {@link ServerConnector} which can process a
 * {@link ClientHistoryChangeEvent}.
 */
public interface HistoryChangeAwareConnector extends ServerConnector {
  ...
  /**
   * Will handle a {@link ClientHistoryChangeEvent}. This will check if a
   * {@link HistoryChangeServerRpc} is available, if so it will send it to the
