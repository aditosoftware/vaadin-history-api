...
public interface HistoryLinkClickCallback {
    /**
     * Will handle the actual click on the link. The return value defines the follow-up action for the click.
     * This may either be PUSH or REPLACE or null if nothing shall be done.
     *
    ...
    /**
     * Defines the result of a click callback. This simply represents the basic operations of the History API.
     */
    enum EResult {
        PUSH,
        REPLACE
