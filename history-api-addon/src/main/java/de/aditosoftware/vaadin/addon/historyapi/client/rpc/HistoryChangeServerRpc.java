...
/**
 * Describes a client-to-server rpc which is capable to sending a {@link ClientHistoryChangeEvent}
 * from the client to the server.
 */
public interface HistoryChangeServerRpc extends ServerRpc {
  /**
   * Will trigger a HistoryChang event on the server-side using the given client-side event.
   *
